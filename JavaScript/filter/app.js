...
/* 
  ...
  OCH SKAPAR EN NY ARRAY MED RESULTATET...
*/
...
console.log('filter med function', foundVehicles1);

const foundVehicles2 = vehicles.filter((car) => {
  return car.make.toLowerCase() === 'volvo';
});

console.log('filter med arrow function', foundVehicles2);

const foundVehicles3 = vehicles.filter(
  (car) => car.make.toLowerCase() === 'volvo'
);

console.log('filter med one-liner', foundVehicles3);

const foundVehicles4 = vehicles.filter(
  (car) => car.registrationNo.toLowerCase() === 'ccc123'
);

console.log('filter med one-liner och regnummer', foundVehicles4);
