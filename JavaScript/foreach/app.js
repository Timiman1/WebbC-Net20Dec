...
/* FOREACH LOOP */
//Tar en callback funktion som argument
//funktion anropas för varje element som finns i listan.
...
arr.forEach((number, index) =>
  console.log('One-liner', `index: ${index} ${number}`)
);

vehicles.forEach((car) => console.log(car.make));
